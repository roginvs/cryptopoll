...
import { B, L, ge_frombytes, ge_tobytes, is_zero, point_power, to_point2 } from "./ed25519.mjs";
    ...
    array_to_hex(
      ge_tobytes(
        point_power(
          B,
          array_to_bigint_LE(
            hex_to_array("12581e70a192aeb9ac1411b36d11fc06393db55998190491c063807a6b4d730d"),
          ),
        ),
      ),
    ),
...
check_ge_frombytes("edc876d6831fd2105d0b4389ca2e283166469289146e2ce06faefe98b22548df");

for (const encodedPoint of fs
  .readFileSync("./ed25519.ge_frombytes.testdata.txt")
  .toString()
  .split("\n")
  .map((x) => x.trim())
  .filter((x) => x)) {

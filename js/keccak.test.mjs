...
test("Sample string", () => {
  assert.strictEqual(
    array_to_hex(
      Keccak.keccak256(
        hex_to_array("610d3d69deb94f51dae6e535b88482b5e7e6fab6a89913a8344b273a9f2c1b08"),
      ),
    ),
...
const partsResult = "fd19cafbfbdd2ff63236c744c410796306c12e02083b58da99203c54ced55e71";

test("Long data", () => {
  assert.strictEqual(array_to_hex(Keccak.keccak256(hex_to_array(parts.join("")))), partsResult);
});
